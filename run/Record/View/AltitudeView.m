...
@interface AltitudeView ()<UUChartDataSource>
{
...
- (instancetype)initWithFrame:(CGRect)frame ChartData:(NSArray *)dataArray{
    ...
    if (self) {
        ...
        self.contentSize = CGSizeMake(self.chartView.frame.size.width+10 ,self.frame.size.height);
    }
