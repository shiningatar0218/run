...
//        statusLabel.autoresizingMask = UIViewAutoresizingFlexibleWidth;
        statusLabel.center = CGPointMake(self.center.x, self.center.y-200);
        statusLabel.bounds = CGRectMake(0, 0,self.frame.size.width,20);
...
//        arrowImage.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
        arrowImage.center = CGPointMake(self.center.x, self.center.y+100);
        arrowImage.bounds = CGRectMake(0, 0,60,60);
